...
Batch = namedtuple("Batch", "ids src_tokens src_lengths templ_tokens templ_lengths constraints")
...
def make_batches(lines, args, task, max_positions, encode_fn, translation_connector):
    ...
    template_arr = [translation_connector.get_translation(
                s_in=encode_fn(src_str),
                source_lang="de",
                target_lang="en_pred_probt",
...
def main(args):
    ...
    translation_connector = TranslationConnector()

    for inputs in buffered_read(args.input, args.buffer_size):
        results = []
        for batch in make_batches(inputs, args, task, max_positions, encode_fn, translation_connector):
