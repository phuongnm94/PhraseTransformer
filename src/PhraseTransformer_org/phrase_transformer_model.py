...
class PhraseTransformerEncoder(TransformerEncoder):
    def __init__(self, *args, **kwargs):
        ...
        args_setting = args[0]
        if args_setting.num_phrase_layers is not None and 0 < args_setting.num_phrase_layers < args_setting.encoder_layers:
            for i in range(args_setting.num_phrase_layers-1, args_setting.encoder_layers):
